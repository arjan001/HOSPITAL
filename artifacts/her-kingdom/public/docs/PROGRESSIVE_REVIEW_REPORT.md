...
| Clerk admin SSO (replace token login) | **Not done** | Phase 2 |
...
**Documentation**  
Auth architecture: `docs/ARCHITECTURE.md` §4–§5 · API: `docs/API_DOCUMENTATION.md` §1 · Training: `docs/TRAINING_MANUAL.md` §8–§10
