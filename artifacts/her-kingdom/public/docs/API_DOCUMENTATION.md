...
| ------ | ---- | ----------- |
| `GET`  | `/admin/cms/:collection` | Read a CMS collection (banners, categories, popup-offer, website-settings, custom-pages, footer, audit-log, message-templates). |
...
## 4. Environment variables — exhaustive list
