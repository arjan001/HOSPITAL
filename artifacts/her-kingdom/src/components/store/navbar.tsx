      ...
      <div style={{ background: BG_CREAM, color: TEXT_WINE, borderBottom: "1px solid #F2DCC8" }}>
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex items-center justify-between gap-4 h-20 lg:h-24">
              ...
              <SheetContent side="left" className="w-80 p-0" style={{ background: BG_CREAM, color: TEXT_WINE }}>
                <div className="p-6">
                  <Link href="/" className="inline-flex items-center gap-2">
                    <img src="/logo-rx.png" alt="RX Pharmacy" width={56} height={56} className="h-12 w-12 object-contain" />
                    <span className="text-lg font-bold tracking-wide" style={{ color: TEXT_WINE }}>RX Pharmacy</span>
                  </Link>
                </div>
            ...
            {/* Logo */}
            <Link href="/" className="flex items-center gap-2 shrink-0" aria-label="RX Pharmacy - Home">
              <img
                src="/logo-rx.png"
                alt="RX Pharmacy"
                width={64}
