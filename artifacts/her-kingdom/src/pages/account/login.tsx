        ...
        >
          ...
          <form onSubmit={handleSubmit} className="px-8 py-7 space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <button type="button" className="text-xs font-semibold hover:underline" style={{ color: ACCENT_RED }}>
                Forgot Password?
              </button>
            </div>
            ...
            <button
              type="button"
              className="w-full h-12 rounded-full font-semibold text-sm flex items-center justify-center gap-3 transition-all hover:shadow-md hover:-translate-y-0.5"
